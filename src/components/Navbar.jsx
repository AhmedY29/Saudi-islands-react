...
function Navbar() {
  return (
    <nav className="nav-section flex  justify-center absolute bottom-0 w-full h-[10%] overflow-hidden bg-black/50 text-white py-5 z-10 hover:h-[70%] hover:lg:h-[40%] transition-all duration-200 ">
      <div className="nav-content flex flex-col justify-between items-center w-[80%] gap-10">
        <h1 className="text-4xl">جزر سعودية</h1>
        <div className="cards flex justify-between flex-wrap gap-5 ">
          <Link to={"/"}>
